...
public class MainActivity extends AppCompatActivity {
    ...
    private void generateQuestion() {
        numberOfQuestion = (int) (Math.random() * names.size());//получили номер нашего вопроса
        numberOfAnswer = (int) (Math.random() * buttons.size());
    }
    ...
    public void onClickAnswer(View view) {
        ...
        if (Integer.parseInt(tag) == numberOfAnswer) {
